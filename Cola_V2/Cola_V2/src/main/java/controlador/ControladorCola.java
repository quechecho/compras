...
public class ControladorCola {
    ...
    public ControladorCola(estudiantes est, VistaSubsidios visSub, SalidasPariales salPar, Totales tot, Validar val, VistaCola ent) {
        ...
        // ✅ CORRECCIÓN: Usar la tabla correcta (tblestudiante en lugar de jTblaDatos)
    ...
    public void btnVer() {
        // ✅ CORRECCIÓN: Mostrar la vista de subsidios cuando se presiona Ver
        ent.setVisible(true);
        admCol.recorrerCola();
    }
    ...
    private void btnCalcular() {
        ...
        desahabilitarbtn();
        // ✅ CORRECCIÓN: Asegurar que la vista de subsidios esté visible
    ...
    public void titulo() {
        ...
        ent.setTitle("Cola de Estudiantes");
