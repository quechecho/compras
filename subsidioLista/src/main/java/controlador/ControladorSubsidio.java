...
public class ControladorSubsidio {
    ...
    int nro, numEstSub100, numEstSub80, numEstSub60, numEstSub40, numEstSub20, numEstSub00, numTotEstSub, numTotEstAfi;
    ...
    private final String cabecera2[] = {"Nombre", "Apellidos", "Ident", "Promedio", "Val. Matricula"};
    ...
    public void btnAddInicio() {
        estudiantes nuevoEst = new estudiantes(est.getIdeEst(), est.getNomEst(), est.getApeEst(), est.getProSem(), est.getValMatSem());
   ...
   public void btnObtener() {
    ...
    private void btnCalcular() {
        ...
        ArrayList<estudiantes> listaEstudiantes = admLista.ObtenerTodos();
